...
class Jz_qichetansuowang_PageSource(Base):
    __tablename__ = 'jz_qichetansuowang_pagesource'
...
class Jz_qichetansuowang_content(Base):
    __tablename__ = 'jz_qichetansuowang_content'
    __table_args__ = {"useexisting": False}
