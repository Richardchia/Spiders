...
class Jz_qichegongyexiehui_PageSource(Base):
    __tablename__ = 'jz_qichegongyexiehui_pagesource'
...
class Jz_qichegongyexiehui_content(Base):
    __tablename__ = 'jz_qichegongyexiehui_content'
    __table_args__ = {"useexisting": False}
