...
class Jz_dongfangcaifu_PageSource(Base):
    __tablename__ = 'jz_dongfangcaifu_pagesource'
...
class Jz_dongfangcaifu_content(Base):
    __tablename__ = 'jz_dongfangcaifu_content'
    __table_args__ = {"useexisting": False}
