...
"""
#MongoDB settings
MONGODB_JOBS = "mongodb://139.159.187.54:8051/darcy" # MongoDB URI for the jobs, scheduled_jobs & workers database.Defaults to mongodb://127.0.0.1:27017/mrq
...
DASHBOARD_PORT = 5049 #Use this port for mrq-dashboard.Defaults to port 5555.
#DASHBOARD_IP = "139.159.232.202" #Bind the dashboard to this IP. Default is 0.0.0.0, use 127.0.0.1 to restrict access
