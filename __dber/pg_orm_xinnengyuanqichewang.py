...
class Jz_xinnengyuanqichewang_PageSource(Base):
    __tablename__ = 'jz_xinnengyuanqichewang_pagesource'
...
class Jz_xinnengyuanqichewang_content(Base):
    __tablename__ = 'jz_xinnengyuanqichewang_content'
    __table_args__ = {"useexisting": False}
