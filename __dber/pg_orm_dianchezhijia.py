...
class Jz_dianchezhijia_PageSource(Base):
    __tablename__ = 'jz_dianchezhijia_pagesource'
...
class Jz_dianchezhijia_content(Base):
    __tablename__ = 'jz_dianchezhijia_content'
    __table_args__ = {"useexisting": False}
