...
class Jz_dongfengqiche_PageSource(Base):
    __tablename__ = 'jz_dongfengqiche_pagesource'
...
class Jz_dongfengqiche_content(Base):
    __tablename__ = 'jz_dongfengqiche_content'
    __table_args__ = {"useexisting": False}
